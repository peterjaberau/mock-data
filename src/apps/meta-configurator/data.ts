...
const schemaCollection = [
    {label: 'Feature testing Schema', key: 'default', schema: defaultSchema},
    {label: 'Strenda Schema', key: 'strenda', schema: strendaSchema},
    {label: 'Enzymeml Schema', key: 'enzymeml', schema: enzymemlSchema},
    {label: 'Autonomous Vehicle Schema', key: 'autonomousvehical', schema: metaSchemaSimplified},
]




const packagedSchemas = {
    defaultSchema: defaultSchema,
    autonomousVehicleSchema: autonomousVehicleSchema,
    enzymemlSchema: enzymemlSchema,
    metaSchemaSimplified: metaSchemaSimplified,
    schemaOption: schemaOption,
    strendaSchema: strendaSchema,
